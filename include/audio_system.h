...
AudioAmplifier           Volume;           //xy=678.0000076293945,99.00001335144043
...
AudioConnection          patchCord17(velocity_env, 0, ring, 0);
AudioConnection          patchCord18(mix_delay1, 0, mix_delay_wet, 1);
AudioConnection          patchCord19(mix_delay2, 0, mix_delay_wet, 2);
AudioConnection          patchCord20(mix_ring_wet, 0, ring, 1);
AudioConnection          patchCord21(ring, filter_attenuator);
AudioConnection          patchCord22(mix_osc, Volume);
...
AudioConnection          patchCord26(Volume, 0, i2s2, 0);
AudioConnection          patchCord27(Volume, 0, i2s2, 1);
AudioConnection          patchCord28(filter_attenuator, 0, LPF, 0);
AudioConnection          patchCord29(ADSR_vol, vel_change_low);
AudioConnection          patchCord30(ADSR_vol, vel_change_high);
AudioConnection          patchCord31(ADSR_vol, vel_fade_midi);
